...
def test(debug_status):
    ...
    wheel = threading.Thread(target=Wheel, args=([debug_status]))
    ...
    board = threading.Thread(target=Board, args=([debug_status]))
    ...
    hmi = threading.Thread(target=HMI, args=([debug_status]))
